...
namespace wstkpasek.Models.TrainingModel
{
    public class TrainingRepository : ITrainingRepository
    {
        ...
        /// <summary>
        /// get one trainig by training id and check user is training owner
        /// </summary>
        /// <param name="trainingId">Training id</param>
        /// <param name="email">user email from token</param>
        /// <returns>one user training</returns>
        ...
        /// <summary>
        /// Download and return list of all user trainings
        /// </summary>
        /// <param name="email">user email from token</param>
        /// <returns>List<Training></returns>
        public async Task<List<Training>> GetTrainings(string email)
        {
            var trainings = db.Trainings.Where(t => t.UserEmail == email).OrderBy(o => o.TrainingId);
            return await trainings.AnyAsync() ? await trainings.ToListAsync() : new List<Training>();
        }
        /// <summary>
        /// return true when user is trainig owner
        /// </summary>
        /// <param name="trainingId">training id</param>
        /// <param name="email">user email from token</param>
        ...
        /// <summary>
        /// return list of all exercises assigned training
        /// </summary>
        /// <param name="trainingId">trainig id</param>
        /// <param name="email">user email from token</param>
